// Returns book requests from Supabase `book_requests` table.
...
exports.handler = async (event) => {
  ...
  try {
    let url = `${SUPABASE_URL}/rest/v1/book_requests?select=id,name,email,phone,book_title,author_name,publisher,year,notes,status,created_at&order=created_at.desc&limit=500`;
